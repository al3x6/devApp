...
//        $chiffrement = exec("C:\Users\alexi\AppData\Local\Programs\Python\Python38\python.exe  python\chiffrage.py". ' '. $texte . " " . $cle);
...
//        $chiffrement = exec("C:\Users\alexi\AppData\Local\Programs\Python\Python38\python.exe  python\dechiffrage.py". ' '. $texte . " " . $cle);
